Change <span style="font-family: Courier"> '''TOOL_CHAIN_TAG''' </span> in the file <WorkSpace>Conf\Target.txt for Windows Visual Studio Versions according to the following Matrix
